...
import { AddBounty } from "./pages/AddBounty.js";
...
type Page = "dashboard" | "tasks" | "bountyhub" | "addbounty" | "revenue" | "chat" | "settings";
...
const NAV: { page: Page; label: string; icon: string }[] = [
  ...
  { page: "addbounty", label: "Add Bounty", icon: "M12 4v16m8-8H4" },
